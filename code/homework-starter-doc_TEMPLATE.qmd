...
summary(model4)
```
total plant biomass = 0.05 + 0.12(water treatment) + 0.22(encelia californica) + 0.23(eschscholzia californica) + 0.23(grindelia camporum) + 0.23(nasella pulchra) + 0.05(penstemon centranthifolius) + 0.12(salvia leucophylla)
F(7, 62) = 27.08, p < 0.001, alpha = 0.05, adjusted R^2^ = 0.73
